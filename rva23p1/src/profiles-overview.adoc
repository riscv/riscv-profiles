...
| TSC
| RISC-V International Technical Steering Committee (the governing committee for this Policy)
|===
...
A Minor Profile Release shall only add Optional extensions, change the subcategories of Optional extensions, and make changes allowed by a Deprecation Policy (once one is available). The contents of a Minor Profile release are typically defined using the RISC-V International Fast Track process.
