...
vary in privilege mode.  The initial three families are:
...
example, a platform supporting the S-mode profile can run an operating
system that provides a U-mode execution environment supporting the
U-mode profile.
