...
much smaller common set of choices that capture the most value for
most users, and which thereby provide guidance for hardware
implementers and enable the software community to focus resources on
building a rich software ecosystem.
