...
NOTE: Other profiles are under development: RVM20 and RVM22 for
...
NOTE: Other profiles are to be added later including RVM20U32,
 RVM20S32, RVM20M32 profiles for microcontrollers based on RV32I, and
 RVM20U64, RVM20S64, RVM20M64 profiles for microcontrollers based on
 RV64I.
...
NOTE: It is expected that Svnapot will be mandatory in RVA23.
