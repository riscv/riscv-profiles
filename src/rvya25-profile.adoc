...
NOTE: How to benefit from the combination of pointer masking and CHERI is a research topic.
 RVY harts which also implement Zyhybrid can make use of pointer masking.
...
- *Zicfilp* Landing Pads
 ...
 NOTE: *Zicfiss* Shadow Stack is incompatible with RVY.
...
The following unprivileged (and unratified) ISA extension is general-purpose but added for CHERI software:
